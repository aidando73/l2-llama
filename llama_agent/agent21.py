...
class L2SystemPromptGenerator(PromptTemplateGeneratorBase):
    def gen(self, custom_tools: list[ToolDefinition]) -> str:
        template_str = textwrap.dedent(
            ...
            2. Required parameters MUST be specified
            3. Put the entire function call reply on one line
            4. Always explain your reasoning before each function call in a <thinking> tag
            """
        )
